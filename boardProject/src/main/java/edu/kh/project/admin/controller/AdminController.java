...
public class AdminController {
	...
	public ResponseEntity<Object> selectWithDarwnMemberList() {
	...
	public ResponseEntity<String> resoreMember(@RequestBody Member member) {
		try {
			...
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
					.body("탈퇴회원 복구중 문제 발생:" + e.getMessage());
		}
	}
}